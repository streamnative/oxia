...
type OxiaCoordinationClient interface {
	PushShardAssignments(ctx context.Context, in *ShardAssignments, opts ...grpc.CallOption) (*CoordinationShardAssignmentsResponse, error)
...
func (c *oxiaCoordinationClient) PushShardAssignments(ctx context.Context, in *ShardAssignments, opts ...grpc.CallOption) (*CoordinationShardAssignmentsResponse, error) {
	out := new(CoordinationShardAssignmentsResponse)
	err := c.cc.Invoke(ctx, "/replication.OxiaCoordination/PushShardAssignments", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type OxiaCoordinationServer interface {
	PushShardAssignments(context.Context, *ShardAssignments) (*CoordinationShardAssignmentsResponse, error)
...
func (UnimplementedOxiaCoordinationServer) PushShardAssignments(context.Context, *ShardAssignments) (*CoordinationShardAssignmentsResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method PushShardAssignments not implemented")
}
...
func _OxiaCoordination_PushShardAssignments_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ShardAssignments)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(OxiaCoordinationServer).PushShardAssignments(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/replication.OxiaCoordination/PushShardAssignments",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(OxiaCoordinationServer).PushShardAssignments(ctx, req.(*ShardAssignments))
	}
...
var OxiaCoordination_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "PushShardAssignments",
