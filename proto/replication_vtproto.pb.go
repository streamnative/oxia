...
func (m *NewTermResponse) CloneVT() *NewTermResponse {
	...
	r := &NewTermResponse{
		HeadEntryId: m.HeadEntryId.CloneVT(),
	}
	if len(m.unknownFields) > 0 {
		r.unknownFields = make([]byte, len(m.unknownFields))
		copy(r.unknownFields, m.unknownFields)
...
func (m *AddFollowerRequest) CloneVT() *AddFollowerRequest {
	...
	r := &AddFollowerRequest{
		...
		ShardId:             m.ShardId,
		Term:                m.Term,
		FollowerName:        m.FollowerName,
		FollowerHeadEntryId: m.FollowerHeadEntryId.CloneVT(),
	}
	if len(m.unknownFields) > 0 {
		r.unknownFields = make([]byte, len(m.unknownFields))
		copy(r.unknownFields, m.unknownFields)
...
func (m *SnapshotChunk) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.ChunkCount != 0 {
		i = encodeVarint(dAtA, i, uint64(m.ChunkCount))
		i--
		dAtA[i] = 0x28
	}
	if m.ChunkIndex != 0 {
		i = encodeVarint(dAtA, i, uint64(m.ChunkIndex))
		i--
		dAtA[i] = 0x20
	}
	if len(m.Content) > 0 {
...
func (m *BecomeLeaderRequest) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.ReplicationFactor != 0 {
		i = encodeVarint(dAtA, i, uint64(m.ReplicationFactor))
		i--
		dAtA[i] = 0x20
	}
	if m.Term != 0 {
...
func (m *AddFollowerRequest) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if len(m.FollowerName) > 0 {
		...
		i = encodeVarint(dAtA, i, uint64(len(m.FollowerName)))
		i--
		dAtA[i] = 0x22
	}
	if m.Term != 0 {
...
func (m *Append) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.CommitOffset != 0 {
		i = encodeVarint(dAtA, i, uint64(m.CommitOffset))
		i--
		dAtA[i] = 0x18
	}
	if m.Entry != nil {
...
func (m *SnapshotResponse) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.AckOffset != 0 {
		i = encodeVarint(dAtA, i, uint64(m.AckOffset))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func (m *GetStatusResponse) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.HeadOffset != 0 {
		i = encodeVarint(dAtA, i, uint64(m.HeadOffset))
		i--
		dAtA[i] = 0x18
	}
	if m.Status != 0 {
...
func (m *SnapshotChunk) SizeVT() (n int) {
	...
	if m.ChunkIndex != 0 {
		n += 1 + sov(uint64(m.ChunkIndex))
	}
	if m.ChunkCount != 0 {
		n += 1 + sov(uint64(m.ChunkCount))
	}
	n += len(m.unknownFields)
	return n
}
...
func (m *BecomeLeaderRequest) SizeVT() (n int) {
	...
	if m.ReplicationFactor != 0 {
		n += 1 + sov(uint64(m.ReplicationFactor))
	}
	if len(m.FollowerMaps) > 0 {
