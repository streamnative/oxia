...
type mockNodeAvailabilityListener struct {
	events chan model.ServerInfo
}

func newMockNodeAvailabilityListener() *mockNodeAvailabilityListener {
	return &mockNodeAvailabilityListener{
		events: make(chan model.ServerInfo, 100),
	}
}

func (nal *mockNodeAvailabilityListener) NodeBecameUnavailable(node model.ServerInfo) {
	nal.events <- node
}
...
func (r *mockRpcProvider) ClearPooledConnections(node model.ServerInfo) {
}
...
func (r *mockRpcProvider) FailNode(node model.ServerInfo, err error) {
	r.Lock()
	defer r.Unlock()
...
func (r *mockRpcProvider) RecoverNode(node model.ServerInfo) {
	r.Lock()
	defer r.Unlock()
...
func (r *mockRpcProvider) GetNode(node model.ServerInfo) *mockPerNodeChannels {
	r.Lock()
	defer r.Unlock()
...
func (r *mockRpcProvider) PushShardAssignments(ctx context.Context, node model.ServerInfo) (proto.OxiaCoordination_PushShardAssignmentsClient, error) {
	r.Lock()
	defer r.Unlock()
...
func (r *mockRpcProvider) NewTerm(ctx context.Context, node model.ServerInfo, req *proto.NewTermRequest) (*proto.NewTermResponse, error) {
	r.Lock()
...
func (r *mockRpcProvider) BecomeLeader(ctx context.Context, node model.ServerInfo, req *proto.BecomeLeaderRequest) (*proto.BecomeLeaderResponse, error) {
	r.Lock()
...
func (r *mockRpcProvider) GetStatus(ctx context.Context, node model.ServerInfo, req *proto.GetStatusRequest) (*proto.GetStatusResponse, error) {
	r.Lock()
...
func (r *mockRpcProvider) DeleteShard(ctx context.Context, node model.ServerInfo, req *proto.DeleteShardRequest) (*proto.DeleteShardResponse, error) {
	r.Lock()
...
func (r *mockRpcProvider) AddFollower(ctx context.Context, node model.ServerInfo, req *proto.AddFollowerRequest) (*proto.AddFollowerResponse, error) {
	r.Lock()
...
func (r *mockRpcProvider) GetHealthClient(node model.ServerInfo) (grpc_health_v1.HealthClient, io.Closer, error) {
