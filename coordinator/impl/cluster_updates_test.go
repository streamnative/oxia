...
var (
	s1 = model.ServerInfo{Public: "s1:6648", Internal: "s1:6649"}
	s2 = model.ServerInfo{Public: "s2:6648", Internal: "s2:6649"}
	s3 = model.ServerInfo{Public: "s3:6648", Internal: "s3:6649"}
	s4 = model.ServerInfo{Public: "s4:6648", Internal: "s4:6649"}
	s5 = model.ServerInfo{Public: "s5:6648", Internal: "s5:6649"}
	s6 = model.ServerInfo{Public: "s6:6648", Internal: "s6:6649"}
)
...
func TestClientUpdates_ClusterInit(t *testing.T) {
	newStatus, shardsAdded, shardsToRemove := applyClusterChanges(&model.ClusterConfig{
		...
		Servers: []model.ServerInfo{s1, s2, s3, s4},
