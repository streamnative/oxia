...
var (
	s1 = model.NodeInfo{Public: "s1:6648", Internal: "s1:6649"}
	s2 = model.NodeInfo{Public: "s2:6648", Internal: "s2:6649"}
	s3 = model.NodeInfo{Public: "s3:6648", Internal: "s3:6649"}
	s4 = model.NodeInfo{Public: "s4:6648", Internal: "s4:6649"}
	s5 = model.NodeInfo{Public: "s5:6648", Internal: "s5:6649"}
	s6 = model.NodeInfo{Public: "s6:6648", Internal: "s6:6649"}
)
...
func TestClientUpdates_ClusterInit(t *testing.T) {
	newStatus, shardsAdded, shardsToRemove := applyClusterChanges(&model.ClusterConfig{
		...
		Servers: []model.NodeInfo{s1, s2, s3, s4},
