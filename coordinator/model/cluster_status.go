...
type ShardMetadata struct {
	...
	Leader         *ServerInfo    `json:"leader" yaml:"leader"`
	Ensemble       []ServerInfo   `json:"ensemble" yaml:"ensemble"`
	RemovedNodes   []ServerInfo   `json:"removedNodes" yaml:"removedNodes"`
...
func (sm ShardMetadata) Clone() ShardMetadata {
	r := ShardMetadata{
		...
		Term:           sm.Term,
		Leader:         sm.Leader,
		Ensemble:       make([]ServerInfo, len(sm.Ensemble)),
		RemovedNodes:   make([]ServerInfo, len(sm.RemovedNodes)),
