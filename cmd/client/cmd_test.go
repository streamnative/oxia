...
func TestClientCmd(t *testing.T) {
	...
	for _, test := range []struct {
		...
		{"put-multi", []string{"put", "--max-requests-per-batch", "1", "-k", "2a", "-p", "c", "-k", "2x", "-p", "y"}, "", nil,
		...
		{"get", []string{"get", "-k", "k-put-binary-ok"}, "", nil,
			"\\{\"binary\":false,\"payload\":\"hello2\",\"version\":\\{\"version_id\":6,\"created_timestamp\":\\d+,\"modified_timestamp\":\\d+\\,\"modifications_count\":0}\\}",
			"^$",
		},
		{"get-binary", []string{"get", "-k", "k-put-binary-ok", "-b"}, "", nil,
			"\\{\"binary\":true,\"payload\":\"aGVsbG8y\",\"version\":\\{\"version_id\":6,\"created_timestamp\":\\d+,\"modified_timestamp\":\\d+\\,\"modifications_count\":0}\\}",
			"^$",
		},
		...
		{"get-multi", []string{"get", "-k", "2a", "-k", "2x"}, "", nil,
			"\\{\"binary\":false,\"payload\":\"c\",\"version\":\\{\"version_id\":4,\"created_timestamp\":\\d+,\"modified_timestamp\":\\d+\\,\"modifications_count\":0}\\}\\n{\"binary\":false,\"payload\":\"y\",\"version\":\\{\"version_id\":5,\"created_timestamp\":\\d+,\"modified_timestamp\":\\d+\\,\"modifications_count\":0}\\}",
			"^$",
		},
