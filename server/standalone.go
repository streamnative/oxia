...
func (noOpReplicationRpcProvider) GetReplicateStream(context.Context, string, string, int64, int64, *proto.Checkpoint) (proto.OxiaLogReplication_ReplicateClient, error) {
