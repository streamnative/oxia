...
func objectMeta(component Component, oxia *oxiav1alpha1.OxiaCluster) metaV1.ObjectMeta {
	_resourceName := resourceName(component, oxia.Name)
...
func serviceAccount(component Component, cluster *oxiav1alpha1.OxiaCluster) *coreV1.ServiceAccount {
...
func role(component Component, cluster *oxiav1alpha1.OxiaCluster) *rbacV1.Role {
	if component == Coordinator {
		return &rbacV1.Role{
			ObjectMeta: objectMeta(component, cluster),
...
func roleBinding(component Component, cluster *oxiav1alpha1.OxiaCluster) *rbacV1.RoleBinding {
	_resourceName := resourceName(component, cluster.Name)
...
func service(component Component, cluster *oxiav1alpha1.OxiaCluster, ports []NamedPort) *coreV1.Service {
...
func coordinatorConfigMap(cluster *oxiav1alpha1.OxiaCluster) (*coreV1.ConfigMap, error) {
...
func coordinatorDeployment(cluster *oxiav1alpha1.OxiaCluster) *appsV1.Deployment {
...
func serverStatefulSet(cluster *oxiav1alpha1.OxiaCluster) *appsV1.StatefulSet {
...
func serviceMonitor(component Component, cluster *oxiav1alpha1.OxiaCluster) *monitoringV1.ServiceMonitor {
